    ...
    <div className="min-h-screen bg-background p-6">
      ...
      <header className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-4 text-sm">
          <div className="flex items-center gap-2 bg-yellow-100 text-yellow-700 px-3 py-1.5 rounded-full font-semibold">
            <Clock className="w-4 h-4" />
            <span>{pendingOrders.length} Pending</span>
          </div>
          <div className="flex items-center gap-2 bg-blue-100 text-blue-700 px-3 py-1.5 rounded-full font-semibold">
            <ChefHat className="w-4 h-4" />
            <span>{preparingOrders.length} Preparing</span>
          </div>
          <div className="flex items-center gap-2 bg-green-100 text-green-700 px-3 py-1.5 rounded-full font-semibold">
        ...
        <div>
          ...
          <div className="space-y-4">
            {pendingOrders.length > 0 ? (
              ...
              <div className="bg-card rounded-xl border border-dashed border-border p-8 text-center shadow-card">
